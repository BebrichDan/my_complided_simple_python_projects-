...
from config import NUM_OF_PREDICTIONS, REPORT_TEMPLATE, REPORT_FILENAME, TELEGRAM_BOT_TOKEN, ID_MY_TELEGRAM_CHANEL, error_occurred


if __name__ == '__main__':
    # Основной блок - выполнение всех функций и формирование отчета
    ...
    Research.send_report_status(token=TELEGRAM_BOT_TOKEN, chat_id=ID_MY_TELEGRAM_CHANEL, error=error_occurred)